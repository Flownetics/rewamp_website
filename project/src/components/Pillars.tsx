            ...
            <div className="bg-gradient-to-br from-gray-800/60 via-gray-800/40 to-gray-800/60 border border-gray-700/50 rounded-2xl p-5 sm:p-7 shadow-2xl">
              <div className="relative bg-gradient-to-br from-gray-900/60 to-gray-800/40 rounded-xl p-6 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  {/* Key Highlights Grid with ROI Timeline Component */}
                  <div className="flex gap-3">
                    ...
                    <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/30 flex flex-col justify-center min-w-[140px]">
                      <div className="text-xs text-gray-400 font-light mb-2 uppercase tracking-wider" style={{ fontFamily: "'FF Nort', sans-serif" }}>
                        ROI Timeline
                      </div>
                      <div className="text-xl font-medium text-brand-green mb-1" style={{ fontFamily: "'FF Nort', sans-serif" }}>
                        15 Months
                      </div>
                      <div className="text-[10px] text-gray-400 font-light leading-tight" style={{ fontFamily: "'FF Nort', sans-serif" }}>
